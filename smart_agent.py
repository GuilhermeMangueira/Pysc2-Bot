...
#python3 -m pysc2.bin.agent --map Simple64 --agent smart_agentgent_steps 0.SparseAgent --agent_race terran --max_agent_steps 0
...
class SparseAgent(base_agent.BaseAgent):
    ...
    def step(self, obs):
        ...
        if self.move_number == 0:
            ...
            excluded_actions = []
            if supply_depot_count == 6 or worker_supply == 0:
